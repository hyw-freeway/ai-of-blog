    ...
    async fetchArticle() {
      ...
      try {
        ...
        if (res.code === 200 && res.data) {
          ...
          if (res.data.visibleToGuest !== undefined) {
            this.visibleToGuest = !!res.data.visibleToGuest
          } else if (res.data.visible_to_guest !== undefined) {
            this.visibleToGuest = res.data.visible_to_guest === 1
          } else {
            this.visibleToGuest = true
          }
        } else {
